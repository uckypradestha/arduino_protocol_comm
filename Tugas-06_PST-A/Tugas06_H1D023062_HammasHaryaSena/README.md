...
3. **4 Kabel Jumper**: Untuk menghubungkan komponen.
...
5. **Fungsi `loop`**:
   ...
   - Memberikan jeda di akhir scrolling sebelum memulai kembali dari awal.
     ...
     | 1      | 14       | [ Ya]                                       |
     | 15     | 0        | [Ya Ndak Tau Kok ] ← 16 karakter penuh      |
     | 16     | -1       | [a Ndak Tau Kok T] ← Mulai keluar dari kiri |
     | ...    | ...      | ...                                         |
     | 53     | -38      | [a] ← Karakter terakhir keluar             |
